...
class SettingsRegister(object):
    ...
    def clear(self):
        """Remove all settings from this register
...
class Setting(object):
    ...
    def formfield(self):
        """Returns a django form fields that can be used to edit this setting.
        """
        raise NotImplementedError('The formfield method of this setting %s is not implemented' % self)
...
class PickledSetting(Setting):
    ...
    def decode(self, value):
        ...
        # just return the default (Though this will cause a delete for the setting!).
